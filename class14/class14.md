...
Our data today comes from the HOXA1 gene which is a developmental
transcription factor required for lung fibroblast and HeLa cell cycle
progression.
...
1:1 correspondence with `colData` rows.
...
```
    ...
    Info: Working in directory /Users/alfredphyo/Downloads/BIMM143W26/bimm143_github/class14
...
In the cell cycle, the Mitotic pathway has the most significant
“Entities p-value” of 2.1E-5. Compared to the previous KEGG results, the
most significant does not match because KEGG only shows cell-cycle as
the lowest p-value which is not that specific. Differences in
specificity causes differences between the two methods.
